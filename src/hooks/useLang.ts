...
const dictionary: any = {
  "welcome to the ''meet your peer'' tool!": "Bienvenu dans l'outil ''Rencontre tes pairs''",
  ...
  'watch an example that we’ve made': "Visionnement d'une vidéo produite à titre d'exemple",
  ...
  'record another video with a web camera': 'enregistrer une autre vidéo avec une camera web',
